  ...
  return (
    <div className="mt-3 p-5 flex flex-row">
      <div className="w-1/2">
        ...
        <div className="bg-zinc-800 text-white p-4 rounded-md mt-3 font-semibold">
          {value?.data().content}
        </div>
      ...
      <div className="w-1/2 p-2">
        <nav className="bg-zinc-800 w-full p-3 text-white flex flex-row justify-between items-center">
          ...
          <div className="flex flex-row items-center gap-3">
            ...
            <button
              onClick={() => submitcode()}
              className="bg-green-800 p-2 w-28 flex flex-row items-center justify-center hover:gap-2 transition-all gap-4"
            >
